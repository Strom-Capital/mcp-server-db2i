...
- **Catalog tools.** List schemas, tables, views, indexes, and constraints; describe columns; search tables and columns across libraries; return DDL; list dependent objects; check journaling; read index advice; and profile a table.
