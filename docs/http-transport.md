...
<p align="center">
  <picture>
    ...
    <img src="assets/oauth-sign-in.png" alt="Sign-in page: the db2i/mcp route mark, the heading Sign in to IBM i, a line naming the client and where you return to, a system picker with PROD selected, user profile and password fields, and a Sign in button" width="360" />
  </picture>
</p>
