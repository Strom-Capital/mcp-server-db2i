...
<p align="center">
  <picture>
    ...
    <img src="assets/oauth-sign-in.png" alt="Sign-in page: the Db2 for i MCP Server logo and name, a system picker with prod selected, user profile and password fields, and a Sign in button" width="360" />
  </picture>
</p>
