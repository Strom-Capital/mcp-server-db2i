...
<p align="center">
  <picture>
    ...
    <img src="assets/oauth-sign-in.png" alt="Sign-in page: on the left, the db2i/mcp route mark, the heading Sign in with your IBM i user profile, and the client, return address and read-only access; on the right, a system picker with PROD selected, user profile and password fields, and a Sign in button" width="720" />
  </picture>
</p>
